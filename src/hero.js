            ...
            <section class="w-full min-h-screen bg-white">
                <div class="container relative flex flex-col min-h-screen px-6 py-8 mx-auto">
                    <nav class="md:flex md:items-center md:justify-between">
                        ...
                        <div class="translate-x-0 opacity-100 absolute inset-x-0 z-20 w-full px-6 py-8 mt-8 space-y-6 transition-all duration-300 ease-in-out bg-white top-16 md:bg-transparent md:mt-0 md:p-0 md:top-0 md:relative md:w-auto md:opacity-100 md:translate-x-0 md:space-y-0 md:-mx-6 md:flex md:items-center">
                            <a href="#" class="block text-gray-600 transition-colors duration-300 md:px-6 hover:text-blue-500">Home</a>
                            <a href="#" class="block text-gray-600 transition-colors duration-300 md:px-6 hover:text-blue-500">About Us</a>
                            ...
                            <a href="#" class="block text-gray-600 transition-colors duration-300 md:px-6 hover:text-blue-500">Contact</a>
                    ...
                    <section class="flex items-center flex-1">
                        <div class="flex flex-col w-full ">
                            ...
                            <div class="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
                                <input id="email" type="text" class="px-6 py-3 text-gray-700 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="Email Address" />
                    ...
                    <footer class="flex flex-col items-center mt-12 sm:flex-row sm:justify-between">
                        ...
                        <div class="mt-4 -mx-4 md:mt-0">
                            ...
                            <a href="#" class="px-4 text-gray-700 transition-colors duration-300 hover:text-blue-500">Instagram</a>

                            <a href="#" class="px-4 text-gray-700 transition-colors duration-300 hover:text-blue-500">LinkedIn</a>
                        </div>
                    </footer>
                </div>
            </section>
